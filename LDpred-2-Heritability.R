...
if (args[5]=="2"){
  ...
  if (file.exists(paste(args[2], "ldpred_h2_hapmap.txt", sep="/"))) {
    file.remove(paste(args[2], "ldpred_h2_hapmap.txt", sep="/"))
    print(paste("File", result, "deleted."))
  }
  write.table(h2_est, file = paste(args[2], "ldpred_h2_hapmap.txt", sep="/"), col.names = FALSE)
  
  if (file.exists(paste(args[2], "ldpred_h2_hapmap_variants.txt", sep="/"))) {
    file.remove(paste(args[2], "ldpred_h2_hapmap_variants.txt", sep="/"))
    print(paste("File", result, "deleted."))
  }
  write.table(length(ld), file = paste(args[2], "ldpred_h2_hapmap_variants.txt", sep="/"), col.names = FALSE)
...
if (args[5]=="3"){
  ...
  if (file.exists(paste(args[2], "ldpred_h2_full.txt", sep="/"))) {
    file.remove(paste(args[2], "ldpred_h2_full.txt", sep="/"))
    print(paste("File", result, "deleted."))
  }
  write.table(h2_est, file = paste(args[2], "ldpred_h2_full.txt", sep="/"), col.names = FALSE)
  
  if (file.exists(paste(args[2], "ldpred_h2_full_variants.txt", sep="/"))) {
    file.remove(paste(args[2], "ldpred_h2_full_variants.txt", sep="/"))
    print(paste("File", result, "deleted."))
  }
  write.table(length(ld), file = paste(args[2], "ldpred_h2_full_variants.txt", sep="/"), col.names = FALSE)
